"""
================================================================
  Case Study 2 — Leaf Detection Visualization (Expanded)
...
OUTPUT_DIR  = BASE_DIR / "Case study 2" / "outputs" / "densenet"
MODEL_PATH  = OUTPUT_DIR / "models" / "tomato3class_densenet_final.keras"
...
for cls in CLASSES:
    ...
    for i in range(2):
        ...
        proc_array = tf.keras.applications.densenet.preprocess_input(img_array)
